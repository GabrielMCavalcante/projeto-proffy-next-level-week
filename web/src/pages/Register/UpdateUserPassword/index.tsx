...
function UpdateUserPassword() {
    ...
    async function updateUserPassword() {
        ...
        if (typeof response === 'string') setFeedback(response)
            ...
            processFinishedContext.defineDescription('Agora você já pode logar no Proffy e aproveitar.')
    ...
    return (
        <div id="page-register-update-user-password">
            ...
            <form>
                <div className={setInputClasses('newPassword')}>
                    <input
                ...
                <div className={setInputClasses('repeatPassword')}>
                    <input
                    ...
                    <div className="icon-group">
                        ...
                        >
                            <Icon
                                color={showRepeatPassword ? '#8257E5' : '#6A6180'}
